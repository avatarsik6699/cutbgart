...
/**
 * `/udalit-fon-s-foto-na-dokumenty` — ID/document photo scenario (SPEC.md
 * §5.1, required). Same composition pattern as `pages/product-photo`.
 */
  ...
  return (
    ...
    >
      <header className="flex flex-col gap-2">
        <h1 className="text-2xl font-semibold">Удалить фон с фото на документы</h1>
        <p className="text-sm text-muted-foreground">
          Remove the background from an ID/document photo — a clean cutout you can place
          on any required background color yourself, processed entirely in your browser.
        </p>
      </header>

      <p className="text-sm text-muted-foreground">
        Для загранпаспорта, визы, пропуска или анкеты часто требуется фото на строго
        заданном фоне — белом, голубом или сером. Если снимок сделан дома или на телефон и
        фон неровный или посторонний, загрузите фото сюда: инструмент удалит текущий фон,
        оставив прозрачный PNG с чёткими краями вокруг лица и плеч.
      </p>
      <p className="text-sm text-muted-foreground">
        Обратите внимание: инструмент только удаляет фон, он не подставляет вместо него
        нужный цвет автоматически — прозрачный результат можно подложить на нужный
        однотонный фон в любом графическом редакторе перед печатью или загрузкой в форму.
        Обработка происходит локально, фото не покидает ваше устройство.
      </p>
      ...
      <section className="flex flex-col gap-3 border-t border-border pt-6">
        ...
        <img
          ...
          alt="Document photo before and after background removal"
          loading="lazy"
          width={960}
          height={540}
        ...
        />
        <p className="text-sm text-muted-foreground">
          Слева — фото до обработки, справа — фон удалён, готово для подстановки
          требуемого цвета.
        </p>
      </section>
    </main>
