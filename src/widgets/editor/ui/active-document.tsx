...
import type { BackgroundInteraction } from "./background";
import {
...
import type { EnhancementInteraction } from "./enhancements";
import type { MagicCutoutInteraction } from "./magic-cutout";
import type { ManualCutoutInteraction } from "./manual-cutout";
...
export type ActiveDocumentProps = Readonly<{
...
export function ActiveDocument(props: ActiveDocumentProps) {
