...
export type EditorV2StatusRailProps = {
...
function currentIndex(status: EditorV2StatusRailProps["status"]): number {
...
export function EditorV2StatusRail(props: EditorV2StatusRailProps) {
