...
export function EnhancementsToolPanel(props: EnhancementsToolPanelProps) {
  ...
  let outcomeText = m.enhancementsCurrentKept();
  if (props.outcome === "applied") outcomeText = m.enhancementsApplied();
  else if (props.outcome === "unchanged") outcomeText = m.enhancementsUnchanged();
  else if (props.outcome === "cancelled") outcomeText = m.enhancementsCancelled();
