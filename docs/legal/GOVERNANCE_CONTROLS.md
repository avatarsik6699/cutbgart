...
| `qualityMode` | Until user change/clear | Phase-25 storage controls expose deletion |
...
| Privacy choice | 180 days or policy/category version change | Phase-25 expiry parser and tests |
