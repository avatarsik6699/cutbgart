...
- **release decision** — conservative control selected for Phase 35 regardless of final
  territorial outcome.
...
| Separate consent | Article 9, as amended in 2025, requires consent to be separate from other information/documents the person confirms | Phase-35 analytics choice must not be bundled into Terms or mere continued use |
