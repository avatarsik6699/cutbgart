...
| 44 | 🔄 in-progress | `v0.44.0`; T6 accepted, T7 next | [`PHASE_44.md`](./PHASE_44.md): checkpoint-driven frontend decomposition and render ownership |

**Latest closed phase:** `43`

**Implementation in progress:** Phase 44 checkpoints through `T6` are architect-accepted. `T7` is
...
| Phase 44 | In progress; T2–T6 accepted, T7 is next |
