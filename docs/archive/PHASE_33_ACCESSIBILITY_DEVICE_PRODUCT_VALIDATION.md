...
> This former accessibility/device contract is superseded by `SPEC.md` §8 and
> `docs/ARCHITECTURE_V2.md`. Archive it and regenerate Phase 33 as the editor-v2 foundation before
> implementation.
...
- [ ] `A1` Freeze representative pages, locales, breakpoints and states—including upload,
  ...
  Download, dialogs, batch error/retry details, the existing privacy route and other current controls—and
...
- [ ] `P3` Perform native-speaker RU/EN editorial QA across primary UI, errors and recovery details,
