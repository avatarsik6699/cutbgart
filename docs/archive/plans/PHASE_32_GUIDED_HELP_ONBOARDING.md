...
> **ARCHIVED 2026-07-31 — not an active phase contract.**
> The architect withdrew this direction before completion. The `PHASE_32` number is reserved for a
> replacement brief; prototype source remains recoverable from the local Git archive recorded in
> `docs/STATE.md`.
